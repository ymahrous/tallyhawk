...
export default function CapturePage() {
  ...
  const handleCapture = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // Reset file input so the same file can be re-captured if needed
  ...
  return (
    <div className={`min-h-screen flex flex-col font-sans antialiased ${
      ...
      <div className="flex items-center justify-between p-4 border-b border-white/10">
        ...
        <h1 className="text-sm font-semibold font-mono">edocAI Capture</h1>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 gap-8">
        ...
        {success ? (
          <div className="flex flex-col items-center gap-4 animate-pulse">
            ...
            <p className="text-lg font-medium text-emerald-400">Uploaded!</p>
          </div>
        ) : (
          <>
            ...
            <div className="text-center">
              <h2 className="text-xl font-semibold mb-2">Snap a Receipt</h2>
      ...
      <div className={`p-6 border-t ${isDark ? "border-white/10" : "border-gray-200"}`}>
        ...
        <input 
          ...
          capture="environment" // This tells mobile browsers to open the rear camera directly
