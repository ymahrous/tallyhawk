        ...
        <div className={`rounded-3xl p-1 shadow-2xl border backdrop-blur-xl ${
          ...
          <div className={`rounded-[20px] p-6 md:p-8 ${isDark ? "bg-black/40" : "bg-white"}`}>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className={`ml-4 text-xs font-mono ${isDark ? "text-gray-500" : "text-gray-400"}`}>edocAI</span>
            </div>
            ...
            <div className={`rounded-xl border p-6 ${isDark ? "bg-black/60 border-white/5" : "bg-gray-50 border-gray-200"}`}>
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                ...
                <div className={`p-4 rounded-xl border ${isDark ? "border-white/5 bg-white/5" : "border-gray-200 bg-white"}`}>
                  ...
                  <p className={`text-xl font-semibold ${isDark ? "text-white" : "text-gray-900"}`}>$4,320</p>
                </div>
              </div>
              ...
              <div className={`grid grid-cols-12 gap-4 py-4 border-b items-center ${isDark ? "border-white/5" : "border-gray-100"}`}>
                <div className="col-span-4 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-xs ${isDark ? "text-gray-600" : "text-gray-400"}`}>Acme Corp</p>
                  </div>
                </div>
                ...
                <div className={`col-span-2 text-sm font-medium ${isDark ? "text-white" : "text-gray-900"}`}>$1,250.00</div>
              ...
              <div className={`grid grid-cols-12 gap-4 py-4 border-b items-center ${isDark ? "border-white/5" : "border-gray-100"}`}>
                ...
                <div className={`col-span-2 text-sm font-medium ${isDark ? "text-white" : "text-gray-900"}`}>$49.99</div>
                <div className="col-span-2 text-right">
                  <div className="inline-flex items-center gap-1.5">
                    <div className="w-1.5 h-1.5 rounded-full bg-emerald-400"></div>
                    <span className="text-xs text-emerald-400">Synced</span>
              ...
              <div className="grid grid-cols-12 gap-4 py-4 items-center">
                ...
                <div className={`col-span-2 text-sm font-medium ${isDark ? "text-white" : "text-gray-900"}`}>$340.00</div>
                <div className="col-span-2 text-right">
                  <button className={`text-xs px-3 py-1.5 rounded-lg border font-medium transition-colors ${isDark ? "border-white/10 text-gray-400 hover:bg-white/10" : "border-gray-200 text-gray-500 hover:bg-gray-100"}`}>
                    Sync
                  </button>
                </div>
              </div>
